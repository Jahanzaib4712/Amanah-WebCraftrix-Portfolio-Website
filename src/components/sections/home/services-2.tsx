      ...
      <div className="mx-auto max-w-5xl space-y-8 px-6 md:space-y-16">
        <div className="relative z-10 mx-auto max-w-xl space-y-6 text-center">
          ...
          <ScrollView delay={0.2}>
            <p>
              At Amanah WebCraftrix, we create designs that are more than just visually
              appealing. They&apos;re built to solve problems, connect with
              the audience, and drive results. <br /> Whether you’re starting fresh
              or refining your existing identity, <br /> we’ve got you covered with trust, creativity, and purpose.
